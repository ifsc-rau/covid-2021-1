...
<head>
    ...
    <title>Sistema de Estoque Cadastro</title>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Sistema de Estoque </h3>
                    <h3 class="title has-text-grey">Cadastro</h3>
                    
                    <div class="notification is-success">
                      <p>Cadastro efetuado!</p>
                      <p>Faca login informando o seu usuario e senha <a href="login.php">aqui</a></p>
                    </div>
